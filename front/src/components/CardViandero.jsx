            ...
            <div className="bg-gray-200 p-4 rounded-xl shadow-2xl mb-2 flex flex-col gap-8">
              <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4">
                <div className="flex items-center gap-4 p-3 ">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold ">{viandero.user.nombre} {viandero.user.apellido} <span className=" border border-indigo-800 ml-5 p-2  rounded-full  text-sm text-purple-500">
                    Ver Viandas
                  </span></h3>
