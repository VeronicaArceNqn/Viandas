        ...
        <div className="lg:col-span-3 xl:col-span-5 p-8 h-[100vh] overflow-y-scroll bg-gray-700 dark:bg-gray-400">
          ...
          <div className="bg-gray-100 p-4 rounded-xl shadow-2xl mb-2 flex flex-col gap-8">
            ...
            <div className=" rounded">
              ...
              <p className="text-gray-600 text-left">{viandero.descripcion}</p>
              <p className="text-gray-600 text-center mt-4">
                <span className="text-lg font-bold ">Formas de pago: </span>{" "}
                <span className="text-md text-green-700 uppercase ">
                  {viandero.descripPago}
                </span>
              </p>
            </div>
