...
const Footer = (props) => {
    return (
        ...
        //                 <img src="" className="mr-3 w-14" alt=" Logo" />
        //                     <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-black">Viandas</span>
        //             </a>
        //         </div>
        ...
        //         </div>
        //     </div>
        //     <div className="my-6 md:px-24 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8">
  ...
  <div className="grid grid-rows-1 gap-8 md:grid-cols-12 xl:gap-8">
    <div className="md:col-span-12 xl:col-span-4 flex flex-col gap-4">
      <h1 className="text-3xl font-bold text-gray-900">Viandas <span className='text-sky-300'>OK</span> </h1>
