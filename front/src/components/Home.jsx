...
function App() {
  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center w-auto p-1 bg-gray-50 dark:bg-gray-400 text-black max-h-screem ">
        <HomeSearchBar setViandas={setViandas}  />
        <div className="grid md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6 min-h-screen dark:bg-gray-400 text-black justify-center"> 
